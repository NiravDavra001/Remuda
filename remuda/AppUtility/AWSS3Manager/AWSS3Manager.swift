...
//  remuda
//
//  Created by Macmini on 06/07/21.
//
...
class AWSS3Manager {
    ...
    private func uploadfile(fileUrl: URL, fileName: String, contenType: String, progress: progressBlock?, completion: completionBlock?) {
        ...
        expression.progressBlock = {(task, awsProgress) in
            print("another taks is : ",task)
            print("anotherqtaks is : ",awsProgress)
...
//        let finalURL = Url.replacingOccurrences(of: "PluginKitPlugin", with: "Application")
