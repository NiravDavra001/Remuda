...
struct TackDetailsModel : Codable {
    
    var data : TackDetails?
    var message : String?
    var success : Bool?
    ...
    init(from decoder: Decoder) throws {
        ...
        data = try values.decodeIfPresent(TackDetails.self, forKey: .data)
        message = try values.decodeIfPresent(String.self, forKey: .message)
        success = try values.decodeIfPresent(Bool.self, forKey: .success)
    }
    
}
struct TackDetails : Codable {
    let id : Int?
    let userId : String?
    let title : String?
    let price : Int?
